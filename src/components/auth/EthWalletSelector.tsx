...
export const EthWalletSelector: React.FC<WalletSelectorProps> = React.memo(({
  ...
  const handleLoginWalletLinkConnect = useCallback(() => onLogin && onLogin(ProviderType.WALLET_LINK), [ onLogin ])
  ...
  >
      ...
      <LoginModal.Option type={LoginModalOptionType.WALLET_LINK} onClick={handleLoginWalletLinkConnect}  />
